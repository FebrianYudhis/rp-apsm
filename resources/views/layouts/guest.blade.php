    ...
    <div class="dashboard-main-wrapper">
        ...
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand" href="{{ route('guest') }}">APSM</a>
            </nav>
        </div>
                ...
                <nav class="navbar navbar-expand-lg navbar-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('guest') }}" class="nav-link"><i
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-1" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="{{ route('guest.masuk') }}">Surat Masuk</a>
                                            <a class="nav-link" href="{{ route('guest.keluar') }}">Surat
                                                Keluar</a>
                                            <a class="nav-link" href="{{ route('guest.digital') }}">Surat
                                                Digital</a>
                                        </li>
                                    </ul>
                                </div>
